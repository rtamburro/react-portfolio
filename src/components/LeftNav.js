...
export default function LeftNav() {
    return (
        <div className="fixed hidden w-10 h-full ml-10 mr-auto md:ml-5 lg:flex">
            <ul className="z-20 flex flex-col items-center justify-end h-full space-y-4 text-white">
